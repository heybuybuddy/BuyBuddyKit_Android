...
public class BluetoothLeScannerCompat {
    ...
    private final LocationServicesStatus locationServiceStatus;
    ...
    public void startScan(@NonNull BluetoothAdapter adapter, @Nullable List<ScanFilterCompat> filters, @NonNull ScanSettingsCompat settings, @NonNull ScanCallbackCompat callbackCompat) {
        ...
        try {
            ...
            callbackCompat.onScanFailed(ex.getReason());
            isScannable = false;
        }
    ...
    public void isBleScannable(BluetoothAdapter adapter) throws BluetoothLeCompatException {
        ...
        if (adapter == null) {
            ...
            throw new BluetoothLeCompatException(BluetoothLeCompatException.BLUETOOTH_DISABLED);
        } else if (!locationServiceStatus.isLocationPermissionOk()) {
            throw new BluetoothLeCompatException(BluetoothLeCompatException.LOCATION_PERMISSION_MISSING);
        } else if (!locationServiceStatus.isLocationProviderOk()) {
            throw new BluetoothLeCompatException(BluetoothLeCompatException.LOCATION_SERVICES_DISABLED);
        } else if (!hasBLE) {
            throw new BluetoothLeCompatException(BluetoothLeCompatException.BLUETOOTH_LE_NOT_AVAILABLE);
        }
    }

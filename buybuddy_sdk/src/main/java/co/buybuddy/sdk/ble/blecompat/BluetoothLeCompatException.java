...
public class BluetoothLeCompatException extends RuntimeException {
    ...
    @IntDef({BLUETOOTH_CANNOT_START, BLUETOOTH_DISABLED, BLUETOOTH_NOT_AVAILABLE, LOCATION_PERMISSION_MISSING, LOCATION_SERVICES_DISABLED,
            ...
            SCAN_FAILED_FEATURE_UNSUPPORTED, SCAN_FAILED_OUT_OF_HARDWARE_RESOURCES, UNKNOWN_ERROR_CODE, BLUETOOTH_LE_NOT_AVAILABLE})
     ...
     * Scan did not start correctly because the device does not support it.
     */
    public static final int BLUETOOTH_LE_NOT_AVAILABLE = 10;
    ...
    public BluetoothLeCompatException(@Reason int reason) {
        this.reason = reason;
    }

    public BluetoothLeCompatException(@Reason int reason, Throwable causeException) {
    ...
    public String toString() {
        return "BluetoothLeCompatException{"
    ...
    private String reasonDescription() {
        switch (reason) {
            ...
            case BLUETOOTH_LE_NOT_AVAILABLE:
                return "BLUETOOTH_LE_NOT_AVAILABLE";
